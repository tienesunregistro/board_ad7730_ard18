...
Requiere el IDE de Arduino 1.8.x o superior.
Librerías estándar necesarias: SPI.h, EEPROM.h.
Seleccionar placa: Arduino Nano o Arduino Uno (ATmega328P).
El Kernel utiliza la interrupción INT0 para el ADC; no utilizar el Pin 2 para otros propósitos.
